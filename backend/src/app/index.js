 ...
 * @copyright ©2026 ― Prabhjot Saini. Final year project
 * @version v0.0.1
 *
 */
...
// application database connection establishment (Prisma Client auto-connects on import)
require('../database/connect.postgres.db');
